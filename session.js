import { shuffle, normalize, arraysEqual } from "./utils.js?v=5.3.0";
import { MODE_LABELS, LEVEL_LABELS } from "./config.js?v=5.3.0";
...
export class Session{
 ...
 evaluate(input=""){
  ...
  this.answered=true;const p=this.state.progress[this.mode];p.answered++;if(correct)p.correct++;const reward=false;
  if(correct){
   this.score++;
  }
  this.onState();return{correct,answer,reward};
 }
